...
class PagoServiceTest {
     ...
     */
    @Test
    void testRegistrarPagoMetodoValido() throws IllegalOperationException {
        // Crear un objeto PagoEntity con valores válidos
        PagoEntity pagoEntity = new PagoEntity();
        pagoEntity.setMetodoPago("Tarjeta de Crédito"); // Método válido
        pagoEntity.setMonto(50000.0); // Monto válido
    
        // Guardar el pago en la base de datos
        PagoEntity resultado = pagoService.registrarPago(pagoEntity);
    
        // Verificar que el resultado no es nulo
        assertNotNull(resultado, "El pago registrado no debe ser null");
        
        // Verificar que el ID fue asignado, lo que indica que se guardó en la BD
        assertNotNull(resultado.getId(), "El ID del pago no debe ser null");
        
        // Verificar que el método de pago registrado es el esperado
